...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    private void showNofication (PlaybackStateCompat state) {
        ...
        NotificationCompat.Action playPause_Action = new android.support.v4.app.NotificationCompat.Action(
                icon, play_pause, MediaButtonReceiver.buildMediaButtonPendingIntent(this, PlaybackStateCompat.ACTION_PLAY_PAUSE)
        );

        NotificationCompat.Action playPlay_Action = new android.support.v4.app.NotificationCompat.Action(
                icon, getString(R.string.restart), MediaButtonReceiver.buildMediaButtonPendingIntent(this, PlaybackStateCompat.ACTION_SKIP_TO_PREVIOUS)
        );

        PendingIntent contentPnedingIntent = PendingIntent.getActivity(this, 0, new Intent(this,QuizActivity.class), 0);
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        ...
        mMediaSession.setPlaybackState(mStateBuilder.build());
        showNofication(mStateBuilder.build());
